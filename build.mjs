/**
 * dsh-code-review 构建脚本(esbuild,无其他工具链依赖)。
 *
...
const PLUGIN_ID = '@yangzhe1991/dsh-code-review'
...
await writeFile('lib/types/index.d.ts', [
  '/** dsh-code-review 插件,node 半:无宿主侧行为。 */',
...
console.log('[@yangzhe1991/dsh-code-review] build done: lib/index.js, lib/client.js, lib/types/*.d.ts')
